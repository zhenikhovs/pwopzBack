...
class Module
{
    ...
    {
        if (is_dir(self::getDocRoot() . '/local/modules/' . self::$modulename . '/admin/sprint.editor/settings/')) {
            return self::makeDir('/local/modules/' . self::$modulename . '/admin/sprint.editor/settings/');
        } else {
    ...
    {
        if (is_dir(self::getDocRoot() . '/local/modules/' . self::$modulename . '/admin/sprint.editor/packs/')) {
            return self::makeDir('/local/modules/' . self::$modulename . '/admin/sprint.editor/packs/');
        } else {
